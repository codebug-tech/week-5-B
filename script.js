...
// write the javascript code below
console.log(var myFavoriteColor!= "red");
// my guess: true
...
// my guess: true
// write the javascript code below
console.log(var likesComputers= true && var likesSports= true);

// We can see whether one of two booleans is true using || (OR)
console.log("I like sports and I like knitting")
// my guess: false
// write the javascript code below
console.log(var likesSports= true && var likesKnitting= true);

console.log("I like knitting or I like dogs")
// my guess: false
// write the javascript code below
console.log(var likesKnitting= true || var likesDogs= true);
